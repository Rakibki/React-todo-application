...
const App = () => {
  ...
  return (
    <div>
        <CreateTodo value={value} setValue={setValue} setCount={setCount} count={count} getTodo={getTodo} />
        <div className='flex justify-center'>
          <select onChange={handleChnage} className='bg-[#14b8a6] text-white outline-none font-semibold mb-4 px-5 py-2'>
            <option value="all">All</option>
            <option value="complate">Complate</option>
            <option value="inConplate">In Complate</option>
          </select>
        </div>
        <ShowTodos handleUpdate={handleUpdate} filterText={filterText} TodoComplate={TodoComplate} hanndleDelete={hanndleDelete} todos={todos} />
